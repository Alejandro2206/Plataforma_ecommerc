        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span  style="color: rgb(255, 255, 255);">Emprende</span> 
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="single-header mb-50">
                            <h4 class="font-xxl text-brand">Liz Company</h4>
                        </div>
                                    ...
                                    <article class="first-post mb-30 wow fadeIn animated hover-up">
                                        <div class="img-hover-slide position-relative overflow-hidden">
                                            ...
                                            <div class="post-thumb img-hover-scale">
                                                <a>
                                                    <img src="{{asset('assets/imgs/blog/lizcompanylogo.jpg')}}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h4 class="post-title mb-10 text-limit-2-row" style="color: rgb(0, 0, 0);">The litigants on the screen are not actors </h4>
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row" style="color: rgb(0, 0, 0);">Water Partners With Rag &amp; Bone To Consume</h6>
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row" style="color: rgb(0, 0, 0);">The loss is not all that surprising</h6>
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row" style="color: rgb(0, 0, 0);">We got a right to pick a little fight, Bonanza </h6>
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row" style="color: rgb(0, 0, 0);">My entrance exam was on a book of matches </h6>
                                            <div class="entry-meta meta-13 font-xxs color-grey">
                                        </div>
                                    </div>
                                </div>
