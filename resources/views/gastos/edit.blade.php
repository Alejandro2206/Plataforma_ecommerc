                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="categoria_select" name="categoria_select" required>
                                ...
                                @foreach ($categorias as $categoria)
                                    <option value="{{ $categoria }}" {{ old('categoria_select', $gasto->categoria) == $categoria ? 'selected' : '' }}>
                                        {{ $categoria }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="valor" name="valor"
                                    value="{{ old('valor', $gasto->valor) }}" placeholder="Ingrese el valor" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="concepto" name="concepto"
                                placeholder="Ingrese el concepto" required>{{ old('concepto', $gasto->concepto) }}</textarea>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" id="metodo_pago_select" name="metodo_pago_select" required>
                                    @foreach ($metodosPago as $metodo)
                                        <option value="{{ $metodo }}" {{ old('metodo_pago_select', $gasto->metodo_pago) == $metodo ? 'selected' : '' }}>
                                            {{ $metodo }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="supplier_id" id="supplier_id" class="form-control" {{ old('categoria_select') === 'Servicios públicos' || old('categoria_select') === 'Arriendo' || old('categoria_select') === 'Nómina' ? 'disabled' : '' }}>
                                ...
                                @foreach($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}" {{ old('supplier_id', $gasto->supplier_id) == $supplier->id ? 'selected' : '' }}>
                                        {{ $supplier->company }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="fecha_gasto" name="fecha_gasto"
                                value="{{ old('fecha_gasto', $gasto->fecha_gasto) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="estado" name="estado" required>
                                ...
                                <option value="Deuda" {{ old('estado', $gasto->estado) == 'Deuda' ? 'selected' : '' }}>Deuda</option>
