                        ...
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p style="color: black;"> Encontramos <strong
                                        class="text-brand">{{$products->total()}}</strong> productos para ti!</p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span> Clasificación predeterminada <i
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            ...
                                            <div class="sold-out-overlay" style="margin-bottom: 0;">
                                                <center>
                                                    <p class="sold-out-text" style="color: red; font-weight: bold;">Agotado</p>
                                                </center>
                                            </div>                                            
                                            @endif
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            ...
                                            @else
                                            <a aria-label="Añadir a la lista de deseos" class="action-btn hover-up"
                                                href="#"
